...
data class UserResponse(val success:Boolean, val name:String, val cpf:String, val statecity:String, val cep:String, val address:String, val email:String) : Serializable
